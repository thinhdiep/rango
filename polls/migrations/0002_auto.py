...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field house on 'Family'
        m2m_table_name = db.shorten_name(u'polls_family_house')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('family', models.ForeignKey(orm[u'polls.family'], null=False)),
            ('house', models.ForeignKey(orm[u'polls.house'], null=False))
        ))
        db.create_unique(m2m_table_name, ['family_id', 'house_id'])


    def backwards(self, orm):
        # Removing M2M table for field house on 'Family'
        db.delete_table(db.shorten_name(u'polls_family_house'))
